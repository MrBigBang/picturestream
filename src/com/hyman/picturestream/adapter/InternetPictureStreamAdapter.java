...
public class InternetPictureStreamAdapter extends ArrayAdapter<String> implements
		OnScrollListener {
	...
	public InternetPictureStreamAdapter(Context context, int textViewResourceId,
